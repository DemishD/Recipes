...
namespace Recipes.Migrations
{
    ...
    [Migration("20240701183921_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recipes.Models.Favorites", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recipes.Models.KitchenType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recipes.Models.RecipeSteps", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recipes.Models.Step", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recipes.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recipes.Models.Recipe", b =>
                {
                    ...
                    b.HasOne("Recipes.Models.Ingredient", null)
                        .WithMany("Recipe")
                        .HasForeignKey("IngredientId");

                    b.HasOne("Recipes.Models.KitchenType", "KitchenType")
                        .WithMany("Recipe")
                        .HasForeignKey("KitchenTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recipes.Models.Step", null)
                        .WithMany("Recipe")
            ...
            modelBuilder.Entity("Recipes.Models.RecipeIngredients", b =>
                {
                    ...
                    b.HasOne("Recipes.Models.Unit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("Recipes.Models.RecipeSteps", b =>
                {
                    ...
                    b.HasOne("Recipes.Models.Step", "Step")
                        .WithMany()
                        .HasForeignKey("StepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
